...
popd
pushd ..
cp -a bdsmatrix buildavx512
popd
pushd ..
cp -a bdsmatrix buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740088511
...
/V4/usr/lib64/R/library/bdsmatrix/libs/bdsmatrix.so
/VA/usr/lib64/R/library/bdsmatrix/libs/bdsmatrix.so
